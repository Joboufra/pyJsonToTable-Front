...
export default function JsonInput({ jsonInput, setJsonInput, handleSubmit, isModalOpen }) {
  return (
    <div className="flex flex-col h-screen bg-gray-100/10 p-4 overflow-hidden">
      <textarea
      ...
      <button
        className="bg-teal-600 hover:bg-teal-700 text-slate-100 font-bold mt-4 p-4 rounded-xl flex items-center justify-center gap-2"
